...
import { AristotleJobStatus } from "./part/aristotle-job-status";
...
function ToolPart({
  ...
  if (type === "tool-leanProof") {
    return <LeanProof messageId={messageId} tool={part} />;
  }

  if (type === "tool-aristotleCheckJob") {
    return <AristotleJobStatus messageId={messageId} tool={part} />;
  }
